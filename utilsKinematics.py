...
print(len(self.time), self.time[0], self.time[-1])
print(len(markerDict['time']), markerDict['time'][0], markerDict['time'][-1])
print("max |Δt|:", np.max(np.abs(self.time - markerDict['time'])) if len(self.time)==len(markerDict['time']) else "len mismatch")
